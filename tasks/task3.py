...
if __name__ == "__main__":
    ...
    file_name = "task3_images_vs_latent_{}_{}_{}_{}.csv".format(args.model, args.feature_reduction_technique, args.label, args.k_latent_semantics)
    get_term_weight_pairs(vectors, file_name)

    file_name = "task3_latent_vs_features_{}_{}_{}_{}.csv".format(args.model, args.feature_reduction_technique, args.label, args.k_latent_semantics)
    ...
    output.write_to_file("visualize_data_z.html",
                         "task3-data-z-{}-{}-{}-{}.html".format(args.model, args.feature_reduction_technique, args.label, args.k_latent_semantics),
                         data_z=data_z,
                         title="TEST")

    output.write_to_file("visualize_feat_z.html",
                         "task3-feat-z-{}-{}-{}-{}.html".format(args.model, args.feature_reduction_technique, args.label, args.k_latent_semantics),
                         feature_z=feature_z,
                         title="TEST")
